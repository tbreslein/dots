...
km("n", "k", "v:count == 0 ? 'gk' : 'k'", expr_opts)
km("n", "j", "v:count == 0 ? 'gj' : 'j'", expr_opts)
...
km("n", "<leadr>gp", "<cmd>Git pull<cr>", opts)
...
km("n", "gs", vim.lsp.buf.signature_help, opts)
km("n", "<space>D", vim.lsp.buf.type_definition, opts)
km("n", "<space>R", vim.lsp.buf.rename, opts)
km("n", "<space>A", vim.lsp.buf.code_action, opts)
km("n", "gr", "<cmd>TroubleToggle lsp_references<cr>", opts)
