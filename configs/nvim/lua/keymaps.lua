...
require("legendary").setup({
  keymaps = {
    { "j", "gj", description = "move between down wrapped lines", mode = { "n", "v" } },
    { "k", "gk", description = "move between up wrapped lines", mode = { "n", "v" } },
    ...
    { "<leader>y", '"+y', description = "yank into system clipboard", mode = { "n", "v" } },
    { "<leader>Y", '"+Y', description = "yank to end of line into system clipboard", mode = { "n" } },
    { "<leader>d", '"+d', description = "delete into system clipboard", mode = { "n", "v" } },
